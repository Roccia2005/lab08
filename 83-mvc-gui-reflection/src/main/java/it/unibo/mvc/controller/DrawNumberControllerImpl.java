...
public final class DrawNumberControllerImpl implements DrawNumberController {
    ...
    private final List<DrawNumberView> multipleView = new ArrayList<>();
    ...
    public void newAttempt(final int n) {
        ...
        for (final DrawNumberView drawNumberView : multipleView) {
            drawNumberView.result(res);
        }
    }
